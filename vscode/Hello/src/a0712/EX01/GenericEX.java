...
// main 메서드에는 두개의 product 객체를 생성하고 사용하는 예제
// 1. Product 객체 product1은 Tv와 String을 타입 매개변수로 지정하여 생성됨
...
//    product1.getModel()을 호출하면 "스마트Tv" 문자열이 반환됨

// 2. Product 객체 product2도 Tv와 String을 타입 매개변수로 지정하여 생성됨
//    product2.setKind(new Car())를 통해 Kind에는 Car객체가
//    product2.setModel("SUV자동차")을 통해 model에는 "SUV자동차" 문자열이 저장
//    product2.getKind()를 호출하면 Car객체가 반환
//    product2.getModel()을 호출하면 "SUV자동차" 문자열이 반환됨

// 제네릭을 사용하면 Product 클래스에서 다양한 종류의 제품을 다룰 수 있으며,
// 타입 안정성과 코드 재사용성을 높일 수 있음